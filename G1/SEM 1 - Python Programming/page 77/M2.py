...
amt_drinks_desserts_per1 = drinks_perl + dessert_perl
amt_drinks_desserts_per2 = drinks_per2 + dessert_per2

# compute tab with tax 
items_cost = amt_personl + amt_person2 
items_drinks_dess_cost = amt_drinks_desserts_per1 + amt_drinks_desserts_per2
percent_drinks_dess_cost = items_drinks_dess_cost / items_cost

tab = items_cost * (1 + tax) 

# display amount owe 
print('\nOrdered items: $', format(items_cost, '.2f')) 
print('Amount spent on drinks and desserts: $', format(items_drinks_dess_cost, '.2f'))
print('Percentage of amount spent on drinks and desserts: ', format(percent_drinks_dess_cost, '.2f'), ' %')
